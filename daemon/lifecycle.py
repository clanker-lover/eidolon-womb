...
async def run(daemon) -> None:
    ...
    # Aliases let the thread store match threads created under old being names
    _being_aliases = {daemon._active_being_name: {"Being", "Eidolon"}}
    daemon._thread_store = ThreadStore(threads_dir, aliases=_being_aliases)
