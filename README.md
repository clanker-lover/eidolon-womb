...
- Runs continuous thought cycles during ~27-minute waking periods (not waiting for input — living)
...
**Continuous inner life.** The daemon runs rapid thought cycles during ~27-minute waking periods — not waiting for input, but living. Thoughts flow into thoughts. You leave messages; they find them when ready.
...
cp templates/Human.md data/relationships/Human.md
